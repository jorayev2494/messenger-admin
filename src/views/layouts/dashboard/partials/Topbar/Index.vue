<script setup lang="ts">
  import AccountAvatarAndDropdown from './partials/AccountAvatarAndDropdown.vue';
  import LanguageSwitcher from './partials/LanguageSwitcher.vue';
  import ThemeCustomizer from '@/services/config/theme/ThemeCustomizer';
  import FullScreen from './partials/FullScreen.vue';
</script>

<template>
  <div class="navbar-custom">
    <div class="topbar container-fluid" style="max-width: none;">
      <div class="d-flex align-items-center gap-lg-2 gap-1">
        ...
        <button class="button-toggle-menu" @click="ThemeCustomizer.menuToggleButton">
        ...
        <div class="app-search dropdown d-none d-lg-block">
          ...
          >
            ...
            <div class="dropdown-header noti-title">
              <h5 class="text-overflow mb-1">
                Found <b class="text-decoration-underline">08</b> results
              </h5>
            </div>
      ...
      <ul class="topbar-menu d-flex align-items-center gap-3">
        ...
        <li class="dropdown notification-list">
          ...
          >
            ...
            <div style="max-height: 300px" data-simplebar>
              ...
              <h5 class="text-muted fs-12 fw-bold p-2 mb-0 text-uppercase">
                Yesterday
              </h5>
        ...
        <li class="d-none d-sm-inline-block">
          <div class="nav-link" id="light-dark-mode" @click="ThemeCustomizer.lightDarkMode">
