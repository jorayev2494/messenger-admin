              ...
              <div class="col-6">
                ...
                <p class="mb-0 text-muted">
                  <span class="text-success me-2"
                    ><i class="ri-arrow-up-line"></i> 3.27%</span
                  >
                </p>
              </div>
              <div class="col-6">
          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col-6">
                ...
                <p class="mb-0 text-muted">
                  <span class="text-success me-2"
                    ><i class="ri-arrow-up-line"></i> 5.38%</span
                  >
                </p>
              </div>
              <div class="col-6">
          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col-6">
                ...
                <p class="mb-0 text-muted">
                  <span class="text-success me-2"
                    ><i class="ri-arrow-up-line"></i> 4.87%</span
                  >
                </p>
              </div>
              <div class="col-6">
              ...
              <div class="col-6">
                ...
                <p class="mb-0 text-muted">
                  <span class="text-white text-opacity-75 me-2"
                    ><i class="ri-arrow-up-line"></i> 11.7%</span
                  >
                </p>
              </div>
              <div class="col-6">
              ...
              <ul class="list-inline mb-0">
                <li class="list-inline-item">
                  <img
                    ...
                    height="18"
                    alt="chrome"
                  /><span class="align-middle">45.87%</span>
                </li>
                <li class="list-inline-item">
                  <img
                    class="ms-3 pe-1"
                    ...
                    height="18"
                    alt="chrome"
                  /><span class="align-middle">3.25%</span>
                </li>
                <li class="list-inline-item">
                  <img
                    class="ms-3 pe-1"
                    ...
                    height="18"
                    alt="chrome"
                  /><span class="align-middle">9.68%</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="card">
          <div class="d-flex card-header justify-content-between align-items-center">
            ...
            <a href="javascript:void(0);" class="btn btn-sm btn-info"
              >Export <i class="ri-download-line ms-1"></i
            ></a>
          </div>
