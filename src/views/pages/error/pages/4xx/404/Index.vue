            ...
            <div class="card bg-transparent mb-0">
              ...
              <div class="card-body p-4">
                <div class="">
                  ...
                  <h4 class="text-uppercase text-danger mt-3">{{ $t('error.4xx.404.label') }}</h4>
                  <p class="text-muted mt-3">{{ $t('error.4xx.404.description') }}</p>

                  <router-link class="btn btn-primary w-100 mt-3" :to="{ name: 'index' }">
